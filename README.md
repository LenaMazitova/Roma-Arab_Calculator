## Тестовое задание на Java: создать калькулятор римских и арабских чисел (+ тесты на junit)

# Требования:
* Калькулятор умеет выполнять операции сложения, вычитания, умножения и деления с двумя числами: a + b, a - b, a * b, a / b. 
* Данные передаются в одну строку. Решение, в котором каждое число и арифмитеческая операция передаются с новой строки считаются неверными.
